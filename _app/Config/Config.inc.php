...
if (!$WorkControlDefineConf):
    ...
    if($_SERVER['HTTP_HOST'] == 'localhost'):
        ...
        define('BASE', 'https://proficam.agenciabee.com'); //Url raiz do site no servidor
    endif;
    define('THEME', 'proficam'); //template do site
endif;
...
if (!$WorkControlDefineConf):
    ...
    define('MAIL_PASS', 'KtDUI2G5N5SF'); //Senha do e-mail de envio
    define('MAIL_SENDER', 'PROFICAM'); //Nome do remetente de e-mail
    ...
    define('LEVEL_ITV_STUDENTS', 6);
    define('LEVEL_ITV_TEACHERS', 6);
    define('LEVEL_ITV_COURSE', 6);
    define('LEVEL_ITV_RESEARCH', 6);
    define('LEVEL_ITV_TESTIMONIALS', 6);
