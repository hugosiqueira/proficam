...
<li class="dashboard_nav_menu_li <?= strstr($getViewInput, 'alunos/') ? 'dashboard_nav_menu_active' : ''; ?>">
    ...
    <ul class="dashboard_nav_menu_sub">
        ...
        <li class="dashboard_nav_menu_sub_li"> <a title="Matriculados" href="dashboard.php?wc=alunos/home&opt=1">Matriculados</a></li>
        <li class="dashboard_nav_menu_sub_li"> <a title="Egressos" href="dashboard.php?wc=alunos/home&opt=2">Egressos</a></li>
