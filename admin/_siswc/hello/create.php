...
if ($HelloId):
    ...
    if ($Read->getResult()):
        ...
        $_SESSION['trigger_controll'] = Erro("<b>Oopss {$Admin['user_name']}</b>, você tentou editar uma popup que não existe ou que foi removida recentemente!", E_USER_NOTICE);
...
<header class="dashboard_header">
    <div class="dashboard_header_title">
        <h1 class="icon-bullhorn"><?= $hello_title ? $hello_title : 'Novo Aviso'; ?></h1>
        <p class="dashboard_header_breadcrumbs">
            &raquo; <?= ADMIN_NAME; ?>
            <span class="crumb">/</span>
            <a title="<?= ADMIN_NAME; ?>" href="dashboard.php?wc=home">Dashboard</a>
            <span class="crumb">/</span>
            <a title="<?= ADMIN_NAME; ?>" href="dashboard.php?wc=hello/home">Avisos</a>
            <span class="crumb">/</span>
            Gerenciar Avisos
        </p>
    </div>
    ...
    <form name="hello_add" action="" method="post" enctype="multipart/form-data">
        ...
        <div class="box box70">
            <div class="panel">
                ...
                <label class="label">
                    ...
                    <input style="font-size: 1.4em;" type="text" name="hello_title" value="<?= $hello_title; ?>" placeholder="Título do Aviso:" required/>
                </label>
                ...
                <div class="label_50">
                    <label class="label">
                        ...
                        <select name="hello_position" required="required">
                            ...
                            <option <?= ($hello_position == 'exit_intent' ? 'selected="selected"' : ''); ?> value="exit_intent">Ao sair da página!</option>
                        </select>
                    </label>

                    <label class="label">
                        <span class="legend">Regra de exibição: <span class="icon-info icon-notext wc_tooltip"><span class="wc_tooltip_balloon">Defina uma palavra chave para disparar seu aviso!</span></span></span>
        ...
        <div class="box box30">
            <div class="post_create_cover">
                ...
                ?>
                <img style="width: 100%;" class="hello_cover" alt="Imagem do Aviso" title="Imagem da Popup" src="../tim.php?src=<?= $HelloImage; ?>&w=<?= IMAGE_W / 3; ?>" default="../tim.php?src=<?= $HelloImage; ?>&w=<?= IMAGE_W / 3; ?>"/>
            </div>
        </div>
    </form>
</div>