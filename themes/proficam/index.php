            ...
            <div class="col-md-3 d-flex services align-self-stretch py-5 px-4 ftco-animate bg-darken">
                <div class="media block-6 d-block text-center">
                    ...
                    <div class="media-body p-2 mt-3">
                        ...
                        <p class="text-light">Nossos alunos saem preparados para atuar diretamente na indústria, veja alguns cases.</p>
                        </a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 d-flex services align-self-stretch py-5 px-4 ftco-animate bg-primary">
                <div class="media block-6 d-block text-center">
                    ...
                    <a href="defesas">
                        ...
                        <p class="text-light">Veja todas dissertações que já foram apresentadas em nosso programa.</p>
                    </a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 d-flex services align-self-stretch py-5 px-4 ftco-animate bg-darken">
                <div class="media block-6 d-block text-center">
                    ...
                    <a href="laboratorios">
                        ...
                        <p class="text-light">Nossos laboratórios contam com as mais novas tecnologias existentes e nossa biblioteca com todo material necessário para sua pesquisa.</p>
                    </a>
                    </div>
                </div>
            </div>
...
<section class="ftco-section ftco-consult py-5"  data-stellar-background-ratio="0.5" style="background-image: url(<?= BASE; ?>/_cdn/images/palestra.jpg);background-repeat: no-repeat;background-size: cover;">
